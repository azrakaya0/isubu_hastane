...
public partial class PatientAppointmentCalendarPage : ContentPage
{
    ...
    public PatientAppointmentCalendarPage()
    {
        InitializeComponent();
    ...
    private void BuildDayChips()
    {
        ...
        for (var i = 0; i < 18; i++)
        {
            DayChipsHost.Children.Add(CreateDayChip(start.AddDays(i)));
        }
    }
    ...
    private View CreateDayChip(DateTime d)
    {
        ...
        var border = new Border
        {
            ...
            BackgroundColor = isSelected ? Color.FromArgb("#2E7D32") : Color.FromArgb("#FFFFFF"),
    ...
    {
        await PageUi.HideListErrorAsync(PageErrorBanner);
        _allAppointments = (await _api.GetPatientPortalAppointmentsAsync()).ToList();
        ApplyFilter();
    }
